...
import { getArticles, loginCheck } from "../../requests";
...
export default class index extends Component {
              ...
              render: (text, record) => {
                ...
                return (
                  <Tooltip title="number">
                    <Tag color={this.numberColor(record.amount)}>
                      {text.amount}
                    </Tag>
                  </Tooltip>
                );
  ...
  render() {
    ...
    return (
      <Card title="article" bordered={false}>
        <Table
